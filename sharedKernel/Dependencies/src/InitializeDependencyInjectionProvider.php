...
class InitializeDependencyInjectionProvider extends ServiceProvider
{
    ...
    {
        $found = glob(__DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR .
            '..' . DIRECTORY_SEPARATOR . 'packages' . DIRECTORY_SEPARATOR . '*' . DIRECTORY_SEPARATOR . 'src' .
            DIRECTORY_SEPARATOR . 'Dependencies' . DIRECTORY_SEPARATOR . 'initialize.php');
